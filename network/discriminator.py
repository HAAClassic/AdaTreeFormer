...
class FC3DDiscriminator(nn.Module):
    ...
    def __init__(self, num_classes, ndf=64, n_channel=1):
        ...
        self.conv1 = nn.Conv3d(
            3, ndf, kernel_size=4, stride=2, padding=1)
...
class FCDiscriminator(nn.Module):
    ...
    def __init__(self, num_classes, ndf=64, n_channel=1):
        ...
        self.conv0 = nn.Conv2d(num_classes, ndf, kernel_size=3, stride=1, padding=1)
        self.conv1 = nn.Conv2d(3, ndf, kernel_size=4, stride=4, padding=1)
