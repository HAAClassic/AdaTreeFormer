...
parser.add_argument('--model-path', type=str, default='/scratch/users/k2254235/ckpts/UDA/Paper_Full_L2C_CutMix_Att_Dis/best_model_mae-148.11_epoch-45.pth', help='saved model path')
parser.add_argument('--data-path', type=str, default='/users/k2254235/Lab/TCT/Dataset/China_103050', help='dataset path')
parser.add_argument('--data-dir-ul', type=str, default='/users/k2254235/Lab/TCT/Dataset/China_103050/', help='data path')   
