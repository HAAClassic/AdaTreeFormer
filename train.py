...
parser.add_argument('--data-dir-shot', default='', help='data path')  
...
class Trainer(object):
    ...
    def setup(self):
        ...
        # 
        self.datasets_shot = { "train": Crowd_TC(os.path.join(args.data_dir_shot, "train_data_5shot"), 
                args.crop_size, downsample_ratio, "train"),"val": Crowd_TC(os.path.join(args.data_dir_shot, "test_data"),
                args.crop_size, downsample_ratio, "val")}
